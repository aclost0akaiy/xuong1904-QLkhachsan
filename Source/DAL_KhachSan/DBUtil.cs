...

{
    public class DBUtil
    {
        public static string connString = @"Data Source=PCKIET\SQLEXPRESS;Initial Catalog=Xuong_KhachSanKhungBo;Integrated Security=True;TrustServerCertificate=True";
