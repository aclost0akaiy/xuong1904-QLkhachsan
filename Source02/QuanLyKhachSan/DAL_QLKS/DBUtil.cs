...
namespace DAL_QLKS
{
    public class DBUtil
    {
        public static string connString = @"Data Source=DESKTOP-MAH8SCD\SQLEXPRESS;Initial Catalog=Xuong001_QuanLyKhachSan;Integrated Security=True;Trust Server Certificate=True";
